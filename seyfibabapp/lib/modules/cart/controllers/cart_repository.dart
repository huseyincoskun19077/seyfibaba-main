...
abstract class CartRepository {
  ...
  Future<Either<Failure, CheckoutResponseModel>> getCheckoutData(String token, String couponCode);
  Future<Either<Failure, CheckoutResponseModel>> guestCheckout(String id);
  ...
  Future<Either<Failure, CouponResponseModel>> applyCoupon(String coupon, String token);

  Either<Failure, CouponResponseModel> getAppliedCoupon();

  Future<Either<Failure, String>> addToCart(AddToCartModel dataModel);
  Future<Either<Failure, Map<String,dynamic>>> draftCheckout(Uri uri,Map<String,dynamic>? body);
...
class CartRepositoryImp extends CartRepository {
  ...
  @override
  Future<Either<Failure, CheckoutResponseModel>>  guestCheckout(String id) async {
    try {
      final result = await remoteDataSource.guestCheckout(id);
      return Right(result);
    } on ServerException catch (e) {
      return Left(ServerFailure(e.message, e.statusCode));
    }
  ...
  @override
  Future<Either<Failure, Map<String,dynamic>>> draftCheckout(Uri uri,Map<String,dynamic>? body) async {
    try {
      final result = await remoteDataSource.draftCheckout(uri,body);
