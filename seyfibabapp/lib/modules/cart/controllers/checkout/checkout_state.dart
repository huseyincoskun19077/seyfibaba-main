...
class CheckoutDraftLoading extends CheckoutState {
  const CheckoutDraftLoading();
}

class CheckoutDraftError extends CheckoutState {
  final String message;
  final int statusCode;
  const CheckoutDraftError(this.message, this.statusCode);

  @override
  List<Object> get props => [message, statusCode];
}

class CheckoutDraftLoaded extends CheckoutState {
  const CheckoutDraftLoaded(this.message);
