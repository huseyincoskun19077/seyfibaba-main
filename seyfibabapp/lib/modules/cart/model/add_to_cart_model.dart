...
class AddToCartModel extends Equatable {
  ...
  final AddToCartState addToState;
  ...
  const AddToCartModel({
    ...
    this.addToState = const AddToCartStateInitial(),
  });
  ...
  AddToCartModel copyWith({
    ...
    return AddToCartModel(
      ...
      addToState: addToState ?? this.addToState,
    );
  }
  ...
  static AddToCartModel init(){
    return const AddToCartModel(
      quantity : 1,
      productId : 0,
      image : '',
      slug : '',
      token : '',
      variantItems: {},
      addToState : AddToCartStateInitial(),
    );
  }
