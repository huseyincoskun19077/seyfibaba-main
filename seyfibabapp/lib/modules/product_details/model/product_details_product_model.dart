...
class ProductDetailsProductModel extends Equatable {
  ...
  final bool allowFurnitureInquiry;
  ...
  const ProductDetailsProductModel({
    ...
    this.allowFurnitureInquiry = false,
  ...
  ProductDetailsProductModel copyWith({
    ...
    return ProductDetailsProductModel(
      ...
      allowFurnitureInquiry:
          allowFurnitureInquiry ?? this.allowFurnitureInquiry,
  ...
  factory ProductDetailsProductModel.fromMap(Map<String, dynamic> map) {
    return ProductDetailsProductModel(
      ...
      vendorId:
          map['vendor_id'] != null ? int.parse(map['vendor_id'].toString()) : -1,
      ...
      brand: map['brand'] != null
          ...
          : null,
      allowFurnitureInquiry: map['allow_furniture_inquiry'] == true ||
          map['allow_furniture_inquiry'] == 1 ||
          map['allow_furniture_inquiry'] == '1',
      furnitureInquiryWhatsapp:
