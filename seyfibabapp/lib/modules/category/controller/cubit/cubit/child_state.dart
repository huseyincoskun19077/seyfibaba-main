...
class ChildCategoryProductsLoadedState extends ChildCategoryState {
  final List<ProductModel> childCategoryProducts;

  const ChildCategoryProductsLoadedState({required this.childCategoryProducts});

  @override
  List<Object> get props => [childCategoryProducts];
}
