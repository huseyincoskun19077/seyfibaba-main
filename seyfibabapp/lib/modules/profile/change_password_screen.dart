...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: RoundedAppBar(titleText: Language.changePassword),
      body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration:
                        InputDecoration(hintText: Language.currentPassword),
                    onChanged: changePassBloc.currentPassChange,
                    validator: (String? value) {
                      if (value == null || value.isEmpty) {
                        return Language.enterCurrentPassword;
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.visiblePassword,
                    decoration: InputDecoration(hintText: Language.password),
                    onChanged: changePassBloc.paswordChange,
                    validator: (String? value) {
                      if (value == null || value.isEmpty) {
                        return Language.enterNewPassword;
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.visiblePassword,
                    decoration:
                        InputDecoration(hintText: Language.reEnterPassword),
