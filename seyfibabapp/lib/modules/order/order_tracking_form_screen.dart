    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(Language.trackingOrderTitle),
        ),
        body: ListView(
          ...
          children: [
            ...
            Text(
              Language.trackYourOrderHint,
              style: const TextStyle(fontSize: 16.0, color: blackColor),
            ),
            verticalSpace(),
            Form(
              ...
              child: TextFormField(
                ...
                validator: (String? id) =>
                    id!.isNotEmpty ? null : Language.orderNumberRequired,
                decoration: InputDecoration(hintText: Language.enterOrderId),
            ...
            BlocConsumer<OrderTrackingCubit, OrderTrackingState>(
              ...
              builder: (context, state) {
                ...
                return PrimaryButton(
                  text: Language.trackOrderButton,
                  onPressed: () {
