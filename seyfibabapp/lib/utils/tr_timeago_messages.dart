...
class TrTimeAgoMessages implements LookupMessages {
  @override
  String prefixAgo() => '';
  ...
  @override
  String aboutAnHour(int minutes) => '1 saat';
...
void registerTrTimeAgoMessages() {
  setLocaleMessages('tr', TrTimeAgoMessages());
}
