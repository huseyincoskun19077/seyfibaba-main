  ...
  return (
    <div className={`w-full ${className}`}>
      <div className="my-5 flex items-center gap-3">
        <div className="h-px flex-1 bg-[#04334a]/10" />
        <span className="text-xs font-600 text-[#04334a]/45">VEYA</span>
        <div className="h-px flex-1 bg-[#04334a]/10" />
      </div>
      ...
      <button
        ...
        onClick={startGoogle}
        disabled={busy}
        className="flex h-[50px] w-full items-center justify-center gap-3 rounded-lg border border-[#04334a]/12 bg-white transition hover:bg-[#F4F6F7] disabled:opacity-60"
      >
        ...
        <span className="text-sm font-600 text-[#04334a]">Google ile devam et</span>
        {busy ? (
