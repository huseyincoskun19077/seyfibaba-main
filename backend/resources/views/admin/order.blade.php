                            ...
                            <tbody>
                                @foreach ($orders as $index => $order)
                                    <tr>
                                        ...
                                        @if($order->payment_method == 'bankpayment' && $order->payment_status == 0)
                                        <a href="{{ route('admin.approve-payment',$order->id) }}" class="btn btn-success btn-sm" onclick="return confirm('Bu siparişin ödemesini onaylamak istediğinize emin misiniz?')"><i class="fa fa-check" aria-hidden="true"></i> Onayla</a>
                                        @endif
                                        </td>
                                    </tr>
                                  @endforeach
