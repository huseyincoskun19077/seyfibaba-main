                    ...
                    <div class="card-body">
                            ...
                            <form action="{{ route('admin.contact-us.update',$contact->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" name="whatsapp" class="form-control" value="{{ $contact->whatsapp }}" placeholder="908503035073">
                                        <small class="text-muted">Ülke kodu ile, boşluksuz (örn: 908503035073 = 0850 303 5073). Boş bırakılırsa telefon kullanılır.</small>
                                    </div>
                        ...
                        <form action="{{ route('admin.contact-us.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label>WhatsApp</label>
                                    <input type="text" name="whatsapp" class="form-control" placeholder="908503035073">
                                    <small class="text-muted">Ülke kodu ile, boşluksuz (örn: 908503035073).</small>
                                </div>
