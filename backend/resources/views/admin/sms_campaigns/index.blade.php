...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <a href="{{ route('admin.sms-campaigns.create') }}" class="btn btn-primary mb-3">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.sms-campaigns.show', $c->id) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                                </tr>
                                @empty
