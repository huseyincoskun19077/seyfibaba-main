                            ...
                            <div class="row">
                                ...
                                @if(\Illuminate\Support\Facades\Schema::hasColumn('sub_categories', 'max_installment'))
                                    <div class="form-group col-12">
                                        ...
                                        <input type="number" min="0" max="12" class="form-control" name="max_installment" value="{{ old('max_installment') }}" placeholder="Boş bırakılırsa ana kategori kuralı geçerli olur">
                                    </div>
                                @endif
