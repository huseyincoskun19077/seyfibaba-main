                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product-sub-category.update',$subCategory->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                @if(\Illuminate\Support\Facades\Schema::hasColumn('sub_categories', 'max_installment'))
                                    <div class="form-group col-12">
                                        <label>Max Taksit (0=Tek Çekim)</label>
                                        <input type="number" min="0" max="12" class="form-control" name="max_installment" value="{{ old('max_installment', $subCategory->max_installment) }}" placeholder="Boş bırakılırsa ana kategori kuralı geçerli olur">
                                    </div>
                                @endif
