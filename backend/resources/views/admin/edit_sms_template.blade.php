                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @include('admin.partials.sms_template_variables', ['template' => $template])
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update-sms-template',$template->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" cols="30" rows="10" class="form-control text-area-5">{{ old('description', $template->description) }}</textarea>
                            </div>
