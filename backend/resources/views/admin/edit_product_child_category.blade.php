                        ...
                        <form action="{{ route('admin.product-child-category.update',$childCategory->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="number" min="0" max="12" class="form-control" name="max_installment" value="{{ old('max_installment', $childCategory->max_installment) }}" placeholder="Boş = alt kategori kuralı">
