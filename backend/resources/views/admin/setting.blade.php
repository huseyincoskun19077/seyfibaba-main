                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-theme-color') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <hr>
                                                            <h6 class="mb-3">Mobil Menü Hub (Arka Plan)</h6>
                                                            <div class="form-group">
                                                                <label>Hub üst arka plan</label>
                                                                <input type="color" class="form-control" name="mobile_hub_bg_top" value="{{ $setting->mobile_hub_bg_top ?? '#FFFBF0' }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Hub alt arka plan</label>
                                                                <input type="color" class="form-control" name="mobile_hub_bg_bottom" value="{{ $setting->mobile_hub_bg_bottom ?? '#F8F8F8' }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Öne çıkan kart (başlangıç)</label>
                                                                <input type="color" class="form-control" name="mobile_hub_feature_start" value="{{ $setting->mobile_hub_feature_start ?? '#FFF3CC' }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Öne çıkan kart (bitiş)</label>
                                                                <input type="color" class="form-control" name="mobile_hub_feature_end" value="{{ $setting->mobile_hub_feature_end ?? '#FFBB38' }}">
                                                            </div>

                                                            <hr>
                                                            <h6 class="mb-2">Mobil Menü Hub Kart Görselleri</h6>
                                                            <p class="text-muted small mb-3">
                                                                JPG veya PNG. Alt %35 koyu/boş bırakın; yazı oraya biner.<br>
                                                                Alışveriş: <strong>1200×600</strong> (2:1) · Salon paneli: <strong>800×800</strong> (1:1) · İkinci el: <strong>800×800</strong> (1:1)
                                                            </p>
                                                            <div class="form-group">
                                                                <label>Alışveriş kartı (1200×600)</label>
                                                                @if(!empty($setting->mobile_hub_shop_image))
                                                                    <div class="mb-2"><img src="{{ asset($setting->mobile_hub_shop_image) }}" alt="" style="max-width:240px;border-radius:8px;"></div>
                                                                @endif
                                                                <input type="file" name="mobile_hub_shop_image" class="form-control-file" accept="image/*">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Salon paneli / CRM kartı (800×800)</label>
                                                                @if(!empty($setting->mobile_hub_crm_image))
                                                                    <div class="mb-2"><img src="{{ asset($setting->mobile_hub_crm_image) }}" alt="" style="max-width:160px;border-radius:8px;"></div>
                                                                @endif
                                                                <input type="file" name="mobile_hub_crm_image" class="form-control-file" accept="image/*">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>İkinci el kartı (800×800)</label>
                                                                @if(!empty($setting->mobile_hub_secondhand_image))
                                                                    <div class="mb-2"><img src="{{ asset($setting->mobile_hub_secondhand_image) }}" alt="" style="max-width:160px;border-radius:8px;"></div>
                                                                @endif
                                                                <input type="file" name="mobile_hub_secondhand_image" class="form-control-file" accept="image/*">
                                                            </div>

                                                            <hr>
                                                            <h6 class="mb-2">Mobil Onboarding (İlk açılış)</h6>
                                                            <p class="text-muted small mb-3">
                                                                Uygulama ilk kurulum slaytları. Boş bırakılırsa uygulamadaki varsayılan görseller kullanılır.<br>
                                                                Önerilen: dikey PNG, metin görselin içinde olsun. Arka plan rengi görselin çevresinde görünür.
                                                            </p>
                                                            <div class="form-group">
                                                                <label>Onboarding arka plan rengi</label>
                                                                <input type="color" class="form-control" name="mobile_onboarding_bg" value="{{ $setting->mobile_onboarding_bg ?? '#F4F0FA' }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>1. slayt (Toptan)</label>
                                                                @if(!empty($setting->mobile_onboarding_image_1))
                                                                    <div class="mb-2"><img src="{{ asset($setting->mobile_onboarding_image_1) }}" alt="" style="max-width:180px;border-radius:8px;"></div>
                                                                @endif
                                                                <input type="file" name="mobile_onboarding_image_1" class="form-control-file" accept="image/*">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>2. slayt (İkinci el)</label>
                                                                @if(!empty($setting->mobile_onboarding_image_2))
                                                                    <div class="mb-2"><img src="{{ asset($setting->mobile_onboarding_image_2) }}" alt="" style="max-width:180px;border-radius:8px;"></div>
                                                                @endif
                                                                <input type="file" name="mobile_onboarding_image_2" class="form-control-file" accept="image/*">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>3. slayt (Salon paneli)</label>
                                                                @if(!empty($setting->mobile_onboarding_image_3))
                                                                    <div class="mb-2"><img src="{{ asset($setting->mobile_onboarding_image_3) }}" alt="" style="max-width:180px;border-radius:8px;"></div>
                                                                @endif
                                                                <input type="file" name="mobile_onboarding_image_3" class="form-control-file" accept="image/*">
                                                            </div>
