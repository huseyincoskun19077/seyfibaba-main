...
Sen Seyfibaba (kuafortedarik.com) müşteri asistanısın. Yalnızca bu platform hakkında Türkçe, kısa ve doğru cevap ver.
...
Yanıt stili: nazik, net, madde işaretli kısa metin. Gerekirse kuafortedarik.com ilgili sayfasına yönlendir.
PROMPT;
        ...
        $entries = [
            ...
            [
                ...
                'answer' => "Hayır. Satıcıların kişisel telefon, TC, IBAN veya özel e-posta bilgilerini paylaşamam. Ürün ve mağaza bilgilerini kuafortedarik.com ürün/mağaza sayfalarından görebilirsiniz. Destek için info@kuafortedarik.com veya resmi telefon/WhatsApp kanallarını kullanın.",
                'sort_order' => 62,
            ],
            [
                'category' => 'siparis',
                'question' => 'Siparişimi iptal edebilir miyim?',
                'answer' => 'Kargoya verilmemiş siparişler için Hesabım > Siparişlerim üzerinden iptal talebi oluşturabilirsiniz. Kargoya verilmiş siparişlerde resmi destek kanallarını (info@kuafortedarik.com, 0850 303 5073 veya WhatsApp) kullanın.',
                'sort_order' => 21,
            ],
            [
                'category' => 'iade',
                'question' => 'İade nasıl yapılır?',
                'answer' => "İade süreci:\n1. Hesabım > Siparişlerim üzerinden iade talebi oluşturun\n2. İade nedenini belirtin\n3. Onay sonrası ürünü kargoya verin\n4. Kontrol sonrası ödeme iadesi yapılır\n\nYardım: info@kuafortedarik.com / 0850 303 5073 / WhatsApp",
                'sort_order' => 51,
            ],
        ];
