    ...
    public function run(): void
    {
        ...
        $documents = [
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Şartlar ve Koşullar | Kuaför Tedarik',
                'meta_description' => 'Kuaför Tedarik pazaryeri kullanım şartları ve koşulları.',
                'source' => 'terms.md',
            ],
            [
                'slug' => 'privacy-policy',
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Gizlilik Politikası | Kuaför Tedarik',
                'meta_description' => 'Kuaför Tedarik gizlilik politikası ve kişisel veri koruma uygulamaları.',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Gizlilik Sözleşmesi | Kuaför Tedarik',
                'meta_description' => 'Kuaför Tedarik gizlilik sözleşmesi metni.',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'KVKK Aydınlatma Metni | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'KVKK Açık Rıza Metni | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'KVKK Başvuru Formu | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Mesafeli Satış Sözleşmesi | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Ön Bilgilendirme Formu | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Teslimat ve İade Şartları | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'seller',
                'meta_title' => 'Satıcı Şartları | Kuaför Tedarik',
                'meta_description' => 'Kuaför Tedarik satıcı paneli kullanım şartları.',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'Yasaklı Ürünler Politikası | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'legal',
                'meta_title' => 'İkinci El İlan Kuralları | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'seller',
                'meta_title' => 'Komisyon Politikası | Kuaför Tedarik',
            ...
            [
                ...
                'is_active' => true,
                'category' => 'seller',
                'meta_title' => 'Hakediş Bilgileri | Kuaför Tedarik',
