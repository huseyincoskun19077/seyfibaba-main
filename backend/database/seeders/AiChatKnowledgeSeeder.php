...
class AiChatKnowledgeSeeder extends Seeder
{
    public function run(): void
    {
        $entries = [
            // Genel
            ['category' => 'genel', 'question' => 'Kuaför Tedarik nedir?', 'answer' => 'Kuaför Tedarik, Türkiye genelinde kuaför, berber ve güzellik profesyonellerine yönelik ekipman, demirbaş ve sarf malzemeleri satan bir online pazaryeri platformudur. Satıcılar mağaza açabilir, alıcılar güvenle alışveriş yapabilir.', 'sort_order' => 1],
            ['category' => 'genel', 'question' => 'Kuaför Tedarik ile nasıl iletişime geçebilirim?', 'answer' => "Resmi Kuaför Tedarik iletişim kanalları:\n- Email: info@kuafortedarik.com\n- Telefon: 0850 303 5073\n- WhatsApp: 0850 303 5073 (https://wa.me/908503035073)\n- Adres: İstiklal Mahallesi, Serdivan/SAKARYA\n\nKişisel veya satıcı özel numarası paylaşılmaz.", 'sort_order' => 2],
            ...
            ['category' => 'urun', 'question' => 'Ürünler orijinal mi?', 'answer' => 'Evet, platformumuzdaki tüm satıcılar orijinal ve kaliteli ürünler sunmaktadır. Her satıcı kendi ürünlerinden sorumludur ve Kuaför Tedarik güvencesiyle satış yapmaktadır.', 'sort_order' => 11],
            ...
            // Sipariş
            ['category' => 'siparis', 'question' => 'Siparişimi nasıl takip edebilirim?', 'answer' => "Siparişinizi takip etmek için:\n1. kuafortedarik.com'a giriş yapın\n2. Profilinizdeki 'Siparişlerim' bölümüne gidin\n3. İlgili siparişin detayına tıklayarak kargo takip numarasını görebilirsiniz", 'sort_order' => 20],
            ['category' => 'siparis', 'question' => 'Siparişimi iptal edebilir miyim?', 'answer' => 'Kargoya verilmemiş siparişler için iptal talebi oluşturabilirsiniz. Kargoya verilmiş siparişler için resmi destek: info@kuafortedarik.com, 0850 303 5073 veya WhatsApp wa.me/908503035073', 'sort_order' => 21],
            ...
            ['category' => 'iade', 'question' => 'İade nasıl yapılır?', 'answer' => "İade süreci:\n1. Profilinizdeki 'Siparişlerim' bölümünden iade talebi oluşturun\n2. İade nedenini belirtin\n3. Satıcı onayından sonra ürünü kargoya verin\n4. Ürün kontrol edildikten sonra ödeme iadesi yapılır\n\nYardım: info@kuafortedarik.com / 0850 303 5073 / WhatsApp", 'sort_order' => 51],

            // Satış sözleşmesi
            ['category' => 'sozlesme', 'question' => 'Satış sözleşmesi / mesafeli satış nedir?', 'answer' => 'Kuaför Tedarik siparişleri mesafeli satış sözleşmesi kapsamındadır. Ürün, fiyat, kargo ve cayma hakkı sipariş öncesi gösterilir. Detaylar kuafortedarik.com sözleşme/şartlar sayfalarındadır. Kişisel satıcı telefonu paylaşılmaz.', 'sort_order' => 55],
            ...
            // Satıcı
            ['category' => 'satici', 'question' => 'Kuaför Tedarik\'da nasıl satıcı olurum?', 'answer' => "Satıcı olmak için:\n1. kuafortedarik.com/become-seller sayfasından başvuru yapın\n2. Gerekli bilgileri doldurun (firma bilgileri, iletişim)\n3. Başvurunuz incelendikten sonra mağazanız aktif edilir\n4. Ürünlerinizi ekleyip satışa başlayabilirsiniz", 'sort_order' => 60],
            ['category' => 'satici', 'question' => 'Satıcı komisyon oranı nedir?', 'answer' => 'Komisyon oranları kategori ve ürün tipine göre değişmektedir. Detaylı bilgi için satıcı başvuru sayfamızı ziyaret edebilir veya info@kuafortedarik.com adresine mail atabilirsiniz.', 'sort_order' => 61],
            ['category' => 'satici', 'question' => 'Satıcı bilgileri / satıcının telefonunu verir misin?', 'answer' => 'Hayır. Satıcıların kişisel telefon, TC, IBAN veya özel e-posta bilgilerini paylaşamam. Ürün/mağaza bilgilerini kuafortedarik.com üzerinden görün. Destek için resmi iletişim kanallarını kullanın.', 'sort_order' => 62],

            // İkinci el
            ['category' => 'ikinci_el', 'question' => 'İkinci el ürünler hakkında bilgi verir misin?', 'answer' => "Kuaför Tedarik'te ikinci el / kullanılmış ürün ilanları platform kurallarına tabidir. Alıcı-satıcı yazışması uygulama içi mesajlaşma ile yapılır. Kişisel telefon/IBAN paylaşımı önerilmez; mümkünse ödemeyi platform üzerinden tamamlayın.", 'sort_order' => 80],
            ...
            // Hesap
            ['category' => 'hesap', 'question' => 'Nasıl üye olurum?', 'answer' => "kuafortedarik.com/signup sayfasından ücretsiz üye olabilirsiniz. Kayıt için ad, soyad, e-posta ve telefon numarası bilgileriniz gereklidir. Telefon doğrulaması ile kayıt tamamlanır.", 'sort_order' => 70],
            ['category' => 'hesap', 'question' => 'Şifremi unuttum, ne yapmalıyım?', 'answer' => "Şifrenizi sıfırlamak için:\n1. kuafortedarik.com/forgot-password sayfasına gidin\n2. Kayıtlı telefon numaranızı girin\n3. SMS ile gelen doğrulama kodunu girin\n4. Yeni şifrenizi belirleyin", 'sort_order' => 71],
        ];
