...
class GeoAuditCleanupSeeder extends Seeder
{
    public function run(): void
    {
        DB::transaction(function () {
            ...
            $this->updateOrInsertFiltered('contact_pages', ['id' => 1], [
                'title' => 'İletişim',
                'description' => "Kuaför Tedarik ekibine ürün tedariği, satıcı başvurusu, sipariş desteği ve iş birliği talepleriniz için ulaşabilirsiniz.\nMesajınızı inceledikten sonra en kısa sürede dönüş sağlanır.",
            ...
            $replacementArticles = [
                [
                    ...
                    'category_slug' => 'guide',
                    'seo_title' => 'Berber Koltuğu Seçim Rehberi | Kuaför Tedarik Blog',
                ...
                [
                    ...
                    'seo_title' => 'Saç Kurutma Makinesi Karşılaştırması | Kuaför Tedarik Blog',
    ...
    protected function updateFooterContent($now): void
    {
        ...
        $payload['about_us'] = 'Kuaför Tedarik, berber ve kuaför salonlarının ekipman, mobilya ve sarf malzeme ihtiyaçlarını tek noktada buluşturan Türkiye merkezli bir pazaryeridir. Profesyonel satıcıları aynı çatı altında toplayarak salon kurulumundan günlük tedarike kadar hızlı ve güvenli alışveriş deneyimi sunar.';
    ...
    protected function updateAboutUsContent($now): void
    {
        ...
        $payload = $this->filterColumns('about_us', [
            'description' => '<p>Kuaför Tedarik, berber ve kuaför profesyonellerinin ekipman, mobilya ve sarf malzeme ihtiyaçlarını tek çatı altında buluşturmak için geliştirilen Türkiye merkezli bir pazaryeridir. Platform; salon kurmak isteyen girişimciler, aktif işletmeler ve yeni tedarikçi arayan profesyoneller için daha hızlı, daha şeffaf ve daha güvenli bir satın alma deneyimi sunmayı hedefler.</p><p>Berber koltuklarından kuaför tezgahlarına, sterilizasyon ekipmanlarından günlük tüketim malzemelerine kadar geniş ürün grupları; farklı satıcıların tekliflerini karşılaştırarak incelenebilir. Böylece kullanıcılar yalnızca ürün değil, fiyat, stok ve satıcı performansı açısından da daha bilinçli karar verebilir.</p><h2>Neden Kuaför Tedarik?</h2><p>Salon sektöründe doğru ekipmana erişim, hizmet kalitesi kadar operasyon verimliliğini de belirler. Kuaför Tedarik bu ihtiyaca odaklanarak kategori bazlı keşif, satıcı mağazaları, kampanya alanları ve içerik rehberleri ile profesyonellerin ihtiyaçlarını tek bir akışta toplamayı amaçlar.</p><p>Gelişen yapımızla birlikte satıcı çeşitliliğini artırmaya, ürün içeriklerini güçlendirmeye ve sektöre özel rehber içerikler üretmeye devam ediyoruz. Hedefimiz, berber ve kuaför ekosisteminde güvenilir bir dijital tedarik noktası olmaktır.</p>',
            'updated_at' => $now,
        ]);
