...

{
...

    {
        ...
        if (Route::is('admin.login') || Route::is('store-login') || Route::is('admin.logout') || Route::is('seller.login') || Route::is('subscribe-request') || Route::is('delivery.man.login') || Route::is('delivery.man.login.submit')) {
