...
class AdminController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $adminType = Admin::TYPE_ADMIN;
        if ($loggedInAdmin && $loggedInAdmin->isSuperAdmin() && $request->filled('admin_type')) {
            $requestedType = (int) $request->admin_type;
            if (in_array($requestedType, [Admin::TYPE_ADMIN, Admin::TYPE_CALL_CENTER], true)) {
                $adminType = $requestedType;
            }
        }
        $admin->admin_type = $adminType;
        $admin->save();
