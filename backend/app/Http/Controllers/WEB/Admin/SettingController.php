...
class SettingController extends Controller
{
    ...
    public function updateThemeColor(Request $request){
        ...
        $setting->mobile_hub_bg_top = $request->mobile_hub_bg_top ?: null;
        $setting->mobile_hub_bg_bottom = $request->mobile_hub_bg_bottom ?: null;
        $setting->mobile_hub_feature_start = $request->mobile_hub_feature_start ?: null;
        $setting->mobile_hub_feature_end = $request->mobile_hub_feature_end ?: null;
        $this->storeHubImage($request, $setting, 'mobile_hub_shop_image', 'hub-shop');
        $this->storeHubImage($request, $setting, 'mobile_hub_crm_image', 'hub-crm');
        $this->storeHubImage($request, $setting, 'mobile_hub_secondhand_image', 'hub-secondhand');
        if (\Illuminate\Support\Facades\Schema::hasColumn('settings', 'mobile_onboarding_bg')) {
            $setting->mobile_onboarding_bg = $request->mobile_onboarding_bg ?: null;
            $this->storeHubImage($request, $setting, 'mobile_onboarding_image_1', 'onboard-1');
            $this->storeHubImage($request, $setting, 'mobile_onboarding_image_2', 'onboard-2');
            $this->storeHubImage($request, $setting, 'mobile_onboarding_image_3', 'onboard-3');
        }
        $setting->save();
    ...
    private function storeHubImage(Request $request, Setting $setting, string $field, string $prefix): void
    {
        ...
        $name = $prefix.'-'.date('Y-m-d-h-i-s-').rand(999, 9999).'.'.$image->getClientOriginalExtension();
